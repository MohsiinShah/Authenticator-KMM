...
import com.mohsin.auth.UriParser
import com.mohsin.auth.domain.encode.Base32
...
class AccountManager(
    ...
    suspend fun createTotpAccount(
        ...
        if(interval > 60) throw CreationError.INTERVAL_MAX_LIMIT.asException()
        ...
        val account = TotpAccount(
            label, parsed.name, issuer ?: parsed.issuer,
